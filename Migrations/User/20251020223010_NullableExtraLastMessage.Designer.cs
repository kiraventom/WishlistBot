...
namespace WishlistBot.Migrations.User
{
    ...
    [Migration("20251020223010_NullableExtraLastMessage")]
    partial class NullableExtraLastMessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WishlistBot.Model.ProfileModel", b =>
                {
            ...
            modelBuilder.Entity("WishlistBot.Model.UserExtraModel", b =>
                {
            ...
            modelBuilder.Entity("WishlistBot.Model.WishViewSettingsModel", b =>
                {
            ...
            modelBuilder.Entity("WishlistBot.Model.ProfileModel", b =>
                {
                    b.HasOne("WishlistBot.Model.UserModel", "User")
                        .WithOne("Profile")
                        .HasForeignKey("WishlistBot.Model.ProfileModel", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WishlistBot.Model.WishViewSettingsModel", b =>
                {
                    ...
                    b.HasOne("WishlistBot.Model.UserModel", "Viewer")
