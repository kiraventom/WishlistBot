...
public static class ListMessageUtils
{
   ...
   public static void AddListControls<TListQuery, TParentQuery>(BotKeyboard keyboard, QueryParameterCollection parameters, int totalCount, ListPositionModel listPosition, Action<int> addButtonAt)
